...
<p>To get involved, join the Slack workspace (black button at bottom left corner of this page). Once there, look for the #eavs_clc channel, where we share updates, tasks, questions, and resources. Joining is not a commitment—-just a way to learn more.</p>
